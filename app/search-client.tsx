...
function CheckIcon() {
  return (
    ...
    >
      <path
        d="M9 16.17 4.83 12l-1.42 1.41L9 19l12-12-1.41-1.41z"
        fill="currentColor"
      />
    </svg>
  );
...
function GlobeIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm-1 17.93A8 8 0 0 1 4.07 13H7a13.1 13.1 0 0 0 .89 4.6 8 8 0 0 1-1 1.33zM9 13h6a11.9 11.9 0 0 1-1.83 6.43A11.9 11.9 0 0 1 9 13zm0-2a11.9 11.9 0 0 1 1.83-6.43A11.9 11.9 0 0 1 14.83 11zm-2-2H4.07A8 8 0 0 1 10.93 4.07 13.1 13.1 0 0 0 7.11 9zm10 0a13.1 13.1 0 0 0-3.82-4.93A8 8 0 0 1 19.93 9zM17 11h2.93a8 8 0 0 1 0 4H17a14.6 14.6 0 0 0 0-4zm-2.11 8.6A13.1 13.1 0 0 0 15.89 15H19a8 8 0 0 1-4.11 4.6z"
        fill="currentColor"
      />
    </svg>
  );
...
function DirectionsIcon() {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden="true">
      <path
        d="M21.71 11.29l-9-9a1 1 0 0 0-1.41 0l-9 9a1 1 0 0 0 0 1.41l9 9a1 1 0 0 0 1.41 0l9-9a1 1 0 0 0 0-1.41zM14 14.5V12h-4v3H8v-4a1 1 0 0 1 1-1h5V7.5l3.5 3.5z"
        fill="currentColor"
      />
    </svg>
  );
            ...
            <div className="search-bar">
              <div className="search-field">
                ...
                <input
                  ...
                  placeholder="Search businesses (e.g. plumbers, coffee shops)"
                  autoComplete="off"
                />
              </div>
              <div className="search-field">
        ...
        {!loading && results && results.length > 0 && (
          <>
            <p className="results-summary">
              ...
              {filterNoWebsite
                ? ` without a website · scanned ${totalBeforeFilter} place${totalBeforeFilter === 1 ? "" : "s"}`
